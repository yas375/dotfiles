= Ryan Bates Dot Files with my modifications

These are config files to set up a system the way I like it.
Also added oh-my-zsh and emacs-config as submodules.

== Installation

  git clone git://github.com/yas375/dotfiles ~/.dotfiles
  cd ~/.dotfiles
...
If using RVM, run the following command to place the sourcing script in your .localrc file (see above):

  echo '[[ -s "$HOME/.rvm/scripts/rvm" ]] && . "$HOME/.rvm/scripts/rvm" # Load RVM function' >> ~/.localrc
  source ~/.localrc
